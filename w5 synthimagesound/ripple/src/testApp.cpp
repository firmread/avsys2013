...
//	ofPopStyle();
    ...
    for (int i = startVector5; i < endVector5; i++){
        int setWidth = ofMap(i, startVector5, endVector5, 0, ofGetWidth()+10);
        ...
        ofCurveVertex(setWidth, ofGetHeight()- baseHeight - volHistory[i] * heightMul);
    ...
    for (int i = startVector4; i < endVector4; i++){
        int setWidth = ofMap(i, startVector4, endVector4, 0, ofGetWidth()+10);
    ...
    for (int i = startVector3; i < endVector3; i++){
        int setWidth = ofMap(i, startVector3, endVector3, 0, ofGetWidth()+10);
    ...
    for (int i = startVector2; i < endVector2; i++){
        int setWidth = ofMap(i, startVector2, endVector2, 0, ofGetWidth()+10);
    ...
    for (int i = startVector1; i < endVector1; i++){
        int setWidth = ofMap(i, startVector1, endVector1, 0, ofGetWidth()+10);
